...
-   The distribution of r-squared estimates appears to be left-skewed, and most of the estimates seem to fall between 0.90 and 0.92, with some higher than 0.93 and some lower than 0.88. Overall, the estimated values of r-squared in this sample are high.
...
-   The distribution of log(β<sup>0∗β</sup>1) fairly symetric. Most of the estimates seem to fall between 7.2 and 7.8, with some estimates going above 8.0 on the higher end and near 6.8 on the lower end.

-   The 95% Confidence Interval of the log(β<sup>0∗β</sup>1) estimates is (7.13, 7.84).
