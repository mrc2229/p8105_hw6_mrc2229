...
* The distribution of log(β^0∗β^1) fairly symetric. Most of the estimates seem to fall between 7.2 and 7.8, with some estimates going above 8.0 on the higher end and near 6.8 on the lower end.